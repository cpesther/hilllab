...
function [] = record_realtime_track_memmap(path, video_number, camera, total_frames, fps)
% RECORD_REALTIME_TRACK_memmap Capture and track particles in near real-time using
...
%% Preallocate memmaps for raw frames
...
while running
    ...
    if strcmpi(str,'y')
        ...
        % Compile the video into an avi file
        disp('Compiling video...');
        compile_memmap_video(raw_file, video_number, fps, width, height)
